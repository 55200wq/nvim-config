...
require("packer").startup({
  function(use)
    ...
    use {'kevinhwang91/nvim-hlslens'} -- 自动清除搜索高亮
    use {'Raimondi/delimitMate'} -- 自动配对插件
    -- ui
    ...
    -- 提升代码编写效率
    use 'liuchengxu/vista.vim' -- 侧边栏显示函数列表以及当前函数所在位置, 支持lsp
    -- markdown
    ...
    use 'lervag/vimtex'
    -- tag
    use 'ludovicchabant/vim-gutentags' -- 自动生成代码标签文件插件
    use 'skywind3000/gutentags_plus' -- 与Gutentags一起使用并提供无缝的数据库切换
    use 'skywind3000/vim-preview' -- 预览
